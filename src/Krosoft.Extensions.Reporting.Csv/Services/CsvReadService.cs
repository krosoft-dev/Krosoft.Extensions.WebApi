...
{
    public IEnumerable<T> GetRecordsFromBase64<T>(IEnumerable<string> files, Encoding encoding, CultureInfo cultureInfo)
    {
    ...
    public IEnumerable<T> GetRecordsFromBase64<T>(string file, Encoding encoding, CultureInfo cultureInfo)
    {
    ...
    public IEnumerable<T> GetRecordsFromPath<T>(string csvPath, Encoding encoding, CultureInfo cultureInfo)
    {
